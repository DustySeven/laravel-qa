                ...
                <div class="card-body">
                    <div class="card-title">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ml-auto">
                                <a href="{{ route('questions.index') }}" class="btn btn-outline-secondary">Back to al Questions</a>
                            </div>
                        </div>
                    </div>
                    <hr>
                    <div class="media">
                        <div class="d-flex flex-column votes-controls">
                            <a title="This question is useful" class="votes_up">
                                <i class="fas fa-caret-up fa-3x"></i>
                            </a>
                            <span class="votes-count">1230</span>
                            <a title="This question is not useful" class="votes-down off">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="media">
                            <div class="d-flex flex-column votes-controls">
                                <a title="This answer is useful" class="votes_up">
                                    <i class="fas fa-caret-up fa-3x"></i>
                                </a>
                                <span class="votes-count">1230</span>
